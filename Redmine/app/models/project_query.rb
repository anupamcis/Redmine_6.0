...
class ProjectQuery < Query
  ...
  def results_scope(options={})
    order_option = [
      "#{Project.table_name}.updated_on DESC",
      group_by_sort_order,
    ...
    # Performance fix (FINDING-003): Always eager load commonly accessed associations
    # Even if not in visible columns, views may access these through helpers
    ...
    # Preload last activity date if needed
