...
module Propshaft
  ...
  # Commenting out this patch as it's causing issues with Propshaft
  # The original purpose was to provide fallback for missing assets
  # but Propshaft should handle this natively
  #
  # Helper.prepend(Module.new do
  #   def compute_asset_path(path, options = {})
  #     result = Rails.application.assets.resolver.resolve(path)
