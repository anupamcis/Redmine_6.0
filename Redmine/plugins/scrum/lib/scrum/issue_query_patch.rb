  ...
  module IssueQueryPatch
    def self.included(base)
      base.class_eval do
        ...
        alias_method :initialize_available_filters, :initialize_available_filters_with_scrum
        ...
        def issues_with_scrum(options = {})
          ...
          when Array
            options[:include] |= [:sprint]
          when Hash
            options[:include] = inc.merge(:sprint => {})
          else
            options[:include] = [:sprint]
          end
        ...
        alias_method :issues, :issues_with_scrum
        ...
        alias_method :issue_ids, :issue_ids_with_scrum
        ...
        alias_method :available_columns, :available_columns_with_scrum
