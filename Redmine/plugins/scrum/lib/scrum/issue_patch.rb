  ...
  module IssuePatch
    def self.included(base)
      base.class_eval do
        ...
        # acts_as_list :scope => :sprint # Commented out - acts_as_list gem not available
        ...
        def assignable_sprints
          ...
          sprints = project.respond_to?(:open_sprints_and_product_backlog) ? project.open_sprints_and_product_backlog.to_a : []
          if sprint
