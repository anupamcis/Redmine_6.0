...
ProjectsController.send(:include, AdvancedRoadmap::ProjectsControllerPatch)

require_relative 'lib/advanced_roadmap/view_hooks'
...
Redmine::Plugin.register :advanced_roadmap_v2 do
  ...
  permission :view_milestones, {:milestones => [:show, :index]}, :read => true

  permission :project_statistics, {}

  requires_redmine :version_or_higher => "2.1.2"

  project_module :issue_tracking do
    permission :view_issue_estimated_hours, {}
    permission :share_version, {}
    permission :actual_dates, {}
    permission :view_milestone_date_logs, {:milestones => [:dates_log]}, :require => :loggedin
  end
  ...
  settings :default => {"show_due_time" => "false",
                        ...
                        "ratio_very_bad" => "1.5",
                        "color_very_bad" => "red",
                        "milestone_notification_in_days" => 2},
