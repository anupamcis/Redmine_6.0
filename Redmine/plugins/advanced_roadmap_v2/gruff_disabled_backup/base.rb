...
module AdvancedRoadmap
  module Gruff
    ...
    class Base
      ...
      include Magick if Object.const_defined?(:Magick)
      include Deprecated
      ...
      # Rotation angle for labels into axis X.
      #
      # By default, labels are not rotated (0.0).
      attr_accessor :labels_x_rotation
