...
Redmine::Plugin.register :redmine_monitoring_controlling do
  ...
  #menu :project_menu, :redmine_monitoring_controlling, { :controller => 'home_monitoring_controlling_project', :action => 'index' }, :caption => :monitoring_controlling_title, param: :project_id
