...
module CodeReviewChangesetPatch
  def self.included(base) # :nodoc:
    ...
    base.class_eval do
      ...
      alias_method :scan_comment_for_issue_ids_without_code_review, :scan_comment_for_issue_ids
      alias_method :scan_comment_for_issue_ids, :scan_comment_for_issue_ids_with_code_review
    end
