...
require 'gravatar'
require_relative 'lib/code_review_application_hooks'
require_relative 'lib/code_review_change_patch'
require_relative 'lib/code_review_changeset_patch'
require_relative 'lib/code_review_issue_patch'
require_relative 'lib/code_review_issue_hooks'
require_relative 'lib/code_review_projects_helper_patch'
require_relative 'lib/code_review_attachment_patch'
...
Redmine::Plugin.register :redmine_code_review do
  ...
  settings :default => {
    'assignment_tracker_id' => "Code Review",
    'tracker_id' => "Code Review"
  }, :partial => "settings/code_review_settings"
