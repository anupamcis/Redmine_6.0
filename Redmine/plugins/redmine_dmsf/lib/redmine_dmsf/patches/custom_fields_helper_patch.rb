    ...
    module CustomFieldsHelperPatch
      def self.included(base)
        ...
        base.class_eval do
          ...
          alias_method :render_custom_fields_tabs_without_render_custom_tab, :render_custom_fields_tabs
          alias_method :render_custom_fields_tabs, :render_custom_fields_tabs_with_render_custom_tab
          alias_method :custom_field_type_options_without_custom_tab_options, :custom_field_type_options
          alias_method :custom_field_type_options, :custom_field_type_options_with_custom_tab_options
        end
      end
