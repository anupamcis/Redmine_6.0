...
require_relative 'douglas_peucker'

require_relative 'redmine_agile/hooks/views_layouts_hook'
require_relative 'redmine_agile/hooks/views_issues_hook'
require_relative 'redmine_agile/hooks/views_versions_hook'
require_relative 'redmine_agile/patches/issue_patch'
require_relative 'redmine_agile/patches/compatibility_patch'

require_relative 'redmine_agile/helpers/agile_helper'

require_relative 'redmine_agile/charts/agile_chart'
require_relative 'redmine_agile/charts/burndown_chart'
require_relative 'redmine_agile/charts/work_burndown_chart'
