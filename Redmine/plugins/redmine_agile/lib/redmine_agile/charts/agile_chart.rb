...
# require 'SVG/Graph/TimeSeries' # Commented out - missing dependency
# require 'SVG/Graph/Line' # Commented out - missing dependency
# require 'SVG/Graph/Plot' # Commented out - missing dependency
# require 'SVG/Graph/Bar' # Commented out - missing dependency
...
module RedmineAgile
  ...
  # Compatibility alias for existing code that uses RedmineAgile::AgileChart
  AgileChart = Charts::AgileChart
end
