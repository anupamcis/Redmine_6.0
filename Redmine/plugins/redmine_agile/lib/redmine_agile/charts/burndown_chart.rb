...
require_relative '../../svg/graph/agile_time_series'
...
module RedmineAgile
  ...
  # Compatibility alias for existing code that uses RedmineAgile::BurndownChart
  BurndownChart = Charts::BurndownChart
end
