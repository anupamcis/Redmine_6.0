      ...
      def self.included(base)
        ...
        base.class_eval do
          ...
          scope :sorted_by_rank, lambda {eager_load(:agile_rank).
                                   order(Arel.sql("COALESCE(#{AgileRank.table_name}.position, 999999)"))}
          alias_method :agile_rank_without_default, :agile_rank
          alias_method :agile_rank, :agile_rank_with_default
        end
      end
