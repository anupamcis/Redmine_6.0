...
# Define the constant that Zeitwerk expects based on the file path
module Generators
...
# Compatibility alias for Rails generator discovery (Rails looks for RedmineCkeditor::RichAssetsGenerator)
module RedmineCkeditor
  RichAssetsGenerator = Generators::RedmineCkeditor::RichAssets::RichAssetsGenerator
end
