module RedmineCkeditor
  module PDFPatch
    def self.included(base)
      base.class_eval do
        ...
        alias_method :get_image_filename_without_ckeditor, :get_image_filename
        alias_method :get_image_filename, :get_image_filename_with_ckeditor
  ...
  Redmine::Export::PDF::ITCPDF.send(:include, PDFPatch) unless Redmine::Export::PDF::ITCPDF.included_modules.include?(PDFPatch)
  
  # Compatibility alias for Zeitwerk (expects PdfPatch from pdf_patch.rb)
  PdfPatch = PDFPatch
end
