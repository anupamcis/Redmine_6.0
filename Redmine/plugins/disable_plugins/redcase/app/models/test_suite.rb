...
class TestSuite < ActiveRecord::Base
	...
	def self.get_root_for_project(project)
		...
		if test_suite.nil?
			test_suite = TestSuite.create(:name => 'Root', parent_id: nil, project_id: project.id)
			# test_suite.project = project
			test_suite.children << TestSuite.create(:name => '.Obsolete', parent_id: nil, project_id: project.id)
			test_suite.children << TestSuite.create(:name => '.Unsorted', parent_id: nil, project_id: project.id)
			test_suite.save
		end
		test_suite
	end
